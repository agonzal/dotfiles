...
oneDarkTheme :: ThemeInfo
oneDarkTheme =
    newTheme { themeName        = "oneDarkTheme"
             , themeAuthor      = "Albert (electr0n) Gonzalez"
             , themeDescription = "Matching decorations for custom OneDark GTK theme"
             , theme            = def { activeColor         = "#1e222a"
                                      , inactiveColor       = "#353b45"
                                      , urgentColor         = "#e06c75"
                                      , activeBorderColor   = "#3e4451"
                                      , inactiveBorderColor = "#3e4451"
                                      , urgentBorderColor   = "#e06c75"
                                      , activeTextColor     = "#98c379"
                                      , inactiveTextColor   = "#565c64"
                                      , urgentTextColor     = "#d19a66"
                                      , fontName            = "xft:Fira Code:bold:size=11"
                                      , decoWidth           = 100
                                      , decoHeight          = 10
                                      }
             }
