...
plugins=(zsh-autosuggestions zsh-completions zsh-syntax-highlighting history-substring-search thefuck z ripgrep fzf fd colored-man-pages command-not-found history zsh_reload catimg git tmux taskwarrior adb pass ufw systemd)
...
alias projects="cd ~/thinkful/code/projects"
alias tcode="cd ~/thinkful/code"
...
export PATH=$PATH:/home/electr0n/.linuxbrew/bin:~/.nvm/versions/node:/home/electr0n/scripts:/home/electr0n/bin
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/electr0n/anaconda3/etc/profile.d/conda.sh" ]; then
        ...
        export PATH="/home/electr0n/scripts:/home/electr0n/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export T2HOME=/home/electr0n/Downloads/tranalyzer2-0.8.8
